...
const AdvanceSearch = (props) => {
    ...
    const handleSubmit = (e) => {
      ...
      const url = `http://localhost:8080/HighRadius_Project1/AdvanceSearchInvoiceServlet?&doc_id=${doc_id}&cust_number=${cust_num}&buisness_year=${bus_year}&invoice_id=${inv_id}`;
