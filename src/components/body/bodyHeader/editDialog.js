...
const EditDialog = (props) => {
  ...
  const handleUpdate = (e) => {
    if(props.select.length > 1){
      ...
      const url = `http://localhost:8080/HighRadius_Project1/UpdateInvoiceServlet?sl_no=${props.select[0]}&invoice_currency=${inv_curr}&cust_payment_terms=${cust_pay_terms}`;
